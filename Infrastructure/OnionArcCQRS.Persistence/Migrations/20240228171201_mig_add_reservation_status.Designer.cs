...
namespace OnionArcCQRS.Persistence.Migrations
{
    ...
    [Migration("20240228171201_mig_add_reservation_status")]
    partial class mig_add_reservation_status
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.About", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.Banner", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.Car", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.CarDescription", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.CarFeature", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.CarPricing", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.Category", b =>
                {
                    b.Property<int>("CategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.Comment", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.Contact", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.Feature", b =>
                {
                    b.Property<int>("FeatureID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.FooterAddress", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.Location", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.Pricing", b =>
                {
                    b.Property<int>("PricingID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.RentACar", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.RentACarProcess", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.Reservation", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.Service", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.SocialMedia", b =>
                {
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.Blog", b =>
                {
                    b.HasOne("OnionArcCQRS.Domain.Entities.Author", "Author")
                        .WithMany("Blogs")
                        .HasForeignKey("AuthorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnionArcCQRS.Domain.Entities.Category", "Category")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.Car", b =>
                {
                    b.HasOne("OnionArcCQRS.Domain.Entities.Brand", "Brand")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.CarDescription", b =>
                {
                    b.HasOne("OnionArcCQRS.Domain.Entities.Car", "Car")
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.CarFeature", b =>
                {
                    ...
                    b.HasOne("OnionArcCQRS.Domain.Entities.Feature", "Feature")
                        .WithMany("CarFeatures")
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.CarPricing", b =>
                {
                    ...
                    b.HasOne("OnionArcCQRS.Domain.Entities.Pricing", "Pricing")
                        .WithMany("CarPricings")
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.RentACar", b =>
                {
                    ...
                    b.HasOne("OnionArcCQRS.Domain.Entities.Location", "Location")
                        .WithMany("RentACars")
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.RentACarProcess", b =>
                {
                    ...
                    b.HasOne("OnionArcCQRS.Domain.Entities.Customer", "Customer")
                        .WithMany("RentACarProcesses")
            ...
            modelBuilder.Entity("OnionArcCQRS.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("OnionArcCQRS.Domain.Entities.Location", "DropOffLocation")
                        .WithMany("DropOffReservation")
                        .HasForeignKey("DropOffLocationID");

                    b.HasOne("OnionArcCQRS.Domain.Entities.Location", "PickUpLocation")
